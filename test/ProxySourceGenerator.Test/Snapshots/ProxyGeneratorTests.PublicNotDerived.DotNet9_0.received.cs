...
namespace Test
{
    partial interface ITestClass 
    {
        ...
        public string APropertyWithBody { get; set; }
        public string APropertyWithExp { get; }
        public string APropertyWithExp2 { get; set; }
        public string APropertyOnlyGetter { get; }
        public string APropertyOnlySetter { set; }
        public string APropertyWithDefaultValue { get; set; }
        public string APropertyOnlyPrivateSetter { get; }
        public void Method();
